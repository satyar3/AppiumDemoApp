...
public class GooglePlayTest 
{
	...
	public void searchPlayStore() throws InterruptedException 
	{
		...
		List<WebElement> recyclerelements = driver.findElements(By.id("com.android.vending:id/suggest_text"));
	...
	{
		//String appdescription = "App: Myntra Online Shopping App10.0MB";
